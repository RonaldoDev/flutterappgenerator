...
class ComponentList extends Component {
    ...
    renderButton() {
      return <ExpansionPanel style={{ width: "100%" }}>
        ...
        <List component="nav">
          <ListItem style={{ width: "100%" }} key="011" button onClick={() =>this.handleAddComponent("button")}>
              <ListItemText primary={"Button"}/>
            </ListItem>
            <ListItem style={{ width: "100%" }} key="022" button onClick={() =>this.handleAddComponent("floatButton")}>
              <ListItemText primary={"Float Button"}/>
            </ListItem>
            <ListItem style={{ width: "100%"} } key="033" button onClick={() =>this.handleAddComponent("iconButton")}>
              <ListItemText primary={"Icon Button"}/>
            </ListItem>
            <ListItem style={{ width: "100%" }} key="044" button onClick={() =>this.handleAddComponent("iconLabelButton")}>
